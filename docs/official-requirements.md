...
Key current points reflected in this repository:

- Proposal submission uses a public repository link plus a roughly one-page PDF proposal.
- Existing projects created before 2026-04-29 may continue as maintenance entries, but effective contest work should focus on commits and improvements after 2026-04-29.
- For acceptance, MoonBit should be the primary implementation language.
